...
var Publication = module.exports.Publication = function(displayName, publicationType, date, thumbnailUri, authors, publisher, extra) {
    ...
    // In case the publication is part of a serial (Journal, Book, ..)
...
var Artefact = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.ARTEFACT, date, null, null, null, extra);
};
...
var Other = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.OTHER, date, null, authors, null, extra);
};
