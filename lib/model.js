...
var Artefact = function(entry) {
    ...
    return new Publication(displayName, PublicationsConstants.publicationTypes.ARTEFACT, date);
};
...
var Book = function(entry) {
    ...
    return new Publication(displayName, PublicationsConstants.publicationTypes.BOOK, date, null, authors, publisher, extra);
};
...
var Chapter = function(entry) {
    ...
    return new Publication(displayName, PublicationsConstants.publicationTypes.CHAPTER, date, null, authors, publisher, extra);
};
...
var Conference = function(entry) {
    ...
    return new Publication(displayName, PublicationsConstants.publicationTypes.CONFERENCE, date, null, authors, publisher, extra);
};
...
var JournalArtical = function(entry) {
    ...
    return new Publication(displayName, PublicationsConstants.publicationTypes.JOURNAL_ARTICLE, date, null, authors, publisher, extra);
};
...
var Report = function(entry) {
    ...
    return new Publication(displayName, PublicationsConstants.publicationTypes.REPORT, date, null, authors, publisher, extra);
};
...
var Thesis = function(entry) {
    ...
    var extra = {};
    return new Publication(displayName, PublicationsConstants.publicationTypes.THESIS, date, null, authors, publisher, extra);
};
