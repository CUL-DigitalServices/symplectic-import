 ...
 */
var Publication = module.exports.Publication = function(displayName, publicationType, date, authors, publisher, publicationStatus, extra) {
    var that = {};
    extra = extra || {};
...
var Artefact = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.ARTEFACT, date, null, null, publicationStatus, extra);
};
...
var Book = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.BOOK, date, authors, publisher, publicationStatus, extra);
};
...
var Chapter = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.CHAPTER, date, authors, publisher, publicationStatus, extra);
};
...
var Conference = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.CONFERENCE, date, authors, publisher, publicationStatus, extra);
};
...
var JournalArticle = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.JOURNAL_ARTICLE, date, authors, publisher, publicationStatus, extra);
};
...
var Other = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.OTHER, date, authors, null, publicationStatus, extra);
};
...
var Report = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.REPORT, date, authors, publisher, publicationStatus, extra);
};
...
var Thesis = function(entry) {
    ...
    return new Publication(displayName, Constants.publicationTypes.THESIS, date, authors, publisher, publicationStatus, extra);
};
